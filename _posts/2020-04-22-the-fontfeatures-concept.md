...
But the nice thing about the idea of inputting anything, storing it in an intermediate representation and then outputting anything, is that you can use fontFeatures as a kind of font engineering Swiss Army Knife. As well as compiling FEE to Adobe .fea, you can use the OTF *front-end* and the AFDKO *back-end* to [https://github.com/simoncozens/fontFeatures/blob/master/otf2fea.py](https://github.com/simoncozens/fontFeatures/blob/master/otf2fea.py) a font file's lookups back into an editable representation.
